...
**Author:** Bruno lobato  
**Author URI:** https://github.com/brunoOLobato 
...
Existem vários tipos diferentes de controles básicos básicos integrados ao personalizador que estão prontos para uso imediato. Isso inclui controles de texto, caixa de seleção, área de texto, rádio, seleção e páginas suspensas. Versões posteriores do WordPress também introduziram controles de Cor, Mídia, Imagem e Imagem Recortada. Se nenhum dos controles básicos básicos atender às suas necessidades, você poderá criar e adicionar seus próprios controles personalizados.

Este código de exemplo mostra como incorporar a funcionalidade do Personalizador em seu tema (ou plug-in), incluindo exemplos de como criar Painéis, Seções e como atualizar a janela Visualização ao vivo. Além de mostrar o uso dos controles principais (integrados), há também vários controles personalizados que foram criados e que você pode usar.

O código de exemplo em customizer.phpcriará um novo Painel no Personalizador chamado Header & Navigationque contém três seções ( Social Icons, Contact& Search). Ele também cria duas novas Seções. Um chamado Sample Custom Controls, que contém exemplos de todos os controles personalizados que criei. A outra nova seção, Default Controls, contém exemplos de todos os controles principais que vêm com o WordPress.
...
O Toggle Switch Custom Control é basicamente apenas um tipo sofisticado de caixa de seleção. Ele permite dois estados, desligado ou ligado.

**Usage**  
add_control( $id, $args );

**Parameters**  
**$id** - (string) (required) Personalizar objeto de controle ou ID da configuração associada a este controle. Default: None  
**$args** - (array) (optional) Um array associativo contendo argumentos para a configuração. Default: empty array  

**Arguments for $args**  
**label** - Optional. O rótulo que será exibido. Default: Blank  
**section** - Required. A Seção onde deve aparecer o controle  
...
O controle deslizante personalizado permite arrastar uma alça em uma barra horizontal para aumentar ou diminuir um valor numérico. O controle também possui um botão de reset, permitindo que você redefina o valor de volta ao valor padrão. O campo de entrada que acompanha mostra o valor do controle deslizante, além de fornecer a capacidade de inserir manualmente um valor.

Você pode especificar os valores mínimo e máximo para o controle deslizante, bem como o tamanho da etapa, que é o tamanho de cada intervalo entre os valores mínimo e máximo.
...
![Sortable Repeater](https://github.com/brunoOLobato/wp-content/uploads/2017/04/SortableRepeater.jpg "Sortable Repeater")
...
![Image Radio Button](https://github.com/brunoOLobato/wp-content/uploads/2017/04/ImageRadioButton.png "Image Radio Button")
...
![Text Radio Button](https://github.com/brunoOLobato/wp-content/uploads/2017/05/TextRadioButton.png "Text Radio Button")
...
![Image Checkbox](https://github.com/brunoOLobato/wp-content/uploads/2017/04/ImageCheckbox.jpg "Image Checkbox")
...
![Single Accordion](https://github.com/brunoOLobato/wp-content/uploads/2017/04/SingleAccordion.jpg "Single Accordion")
...
![Simple Notice](https://github.com/brunoOLobato/wp-content/uploads/2017/04/SimpleNotice.png "Simple Notice")
...
![Dropdown Select2](https://github.com/brunoOLobato/wp-content/uploads/2017/05/DropdownSelect2Control.png "Dropdown Select2")
...
![Dropdown Posts](https://github.com/brunoOLobato/wp-content/uploads/2018/03/DropdownPostsControl.jpg "Dropdown Posts")
...
![Image Checkbox](https://github.com/brunoOLobato/wp-content/uploads/2017/05/TinyMCE-Editor.jpg "TinyMCE Editor")
...
![Google Font Select](https://github.com/brunoOLobato/wp-content/uploads/2017/05/GoogleFontSelect.png "Google Font Select")
...
![Alpha Color](https://github.com/brunoOLobato/wp-content/uploads/2017/04/AlphaColor.jpg "Alpha Color")
...
![Alpha Color](https://github.com/brunoOLobato/wp-content/uploads/2017/05/WPColorPickerAlphaColor.jpg "WPColorPicker Alpha Color")
...
![Image Checkbox](https://github.com/brunoOLobato/wp-content/uploads/2017/05/SortablePillCheckbox.jpg "Sortable Pill Checkbox")
...
![Alpha Color](https://github.com/brunoOLobato/wp-content/uploads/2017/05/Customizer-Customer-Section.jpg "Upsell Section")
...
[The WordPress Customizer – A Developers Guide (Part 1)](https://github.com/brunoOLobato/2017/05/the-wordpress-customizer-a-developers-guide-part-1)  
[The WordPress Customizer – A Developers Guide (Part 2)](https://github.com/brunoOLobato/2017/05/the-wordpress-customizer-a-developers-guide-part-2)
