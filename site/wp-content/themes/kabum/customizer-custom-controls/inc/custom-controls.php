...
/**
 * upsite Customizer Custom Controls
 *
 */
...
if (class_exists('WP_Customize_Control')) {
	 ...
	 *
	 * @author Bruno lobato <https://github.com/brunoOLobato>
	 * @license http://www.gnu.org/licenses/gpl-2.0.html
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Custom_Control extends WP_Customize_Control
	{
		protected function get_upsite_resource_url()
		{
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Custom_Section extends WP_Customize_Section
	{
		protected function get_upsite_resource_url()
		{
			if (strpos(wp_normalize_path(__DIR__), wp_normalize_path(WP_PLUGIN_DIR)) === 0) {
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Image_Checkbox_Custom_Control extends upsite_Custom_Control
	{
		/**
		...
		{
			wp_enqueue_style('upsite-custom-controls-css', $this->get_upsite_resource_url() . 'customizer-custom-controls/css/customizer.css', array(), '1.0', 'all');
		}
		/**
...
?>
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Text_Radio_Button_Custom_Control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Image_Radio_Button_Custom_Control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Single_Accordion_Custom_Control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue()
		{
			wp_enqueue_script('upsite-custom-controls-js', $this->get_upsite_resource_url() . 'customizer-custom-controls/js/customizer.js', array('jquery'), '1.0', true);
			wp_enqueue_style('upsite-custom-controls-css', $this->get_upsite_resource_url() . 'customizer-custom-controls/css/customizer.css', array(), '1.0', 'all');
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Simple_Notice_Custom_Control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Slider_Custom_Control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue()
		{
			wp_enqueue_script('upsite-custom-controls-js', $this->get_upsite_resource_url() . 'customizer-custom-controls/js/customizer.js', array('jquery', 'jquery-ui-core'), '1.0', true);
			wp_enqueue_style('upsite-custom-controls-css', $this->get_upsite_resource_url() . 'customizer-custom-controls/css/customizer.css', array(), '1.0', 'all');
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Toggle_Switch_Custom_control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Sortable_Repeater_Custom_Control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Dropdown_Select2_Custom_Control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue()
		{
			wp_enqueue_script('upsite-select2-js', $this->get_upsite_resource_url() . 'customizer-custom-controls/js/select2.full.min.js', array('jquery'), '4.0.13', true);
			wp_enqueue_script('upsite-custom-controls-js', $this->get_upsite_resource_url() . 'customizer-custom-controls/js/customizer.js', array('upsite-select2-js'), '1.0', true);
			wp_enqueue_style('upsite-custom-controls-css', $this->get_upsite_resource_url() . 'customizer-custom-controls/css/customizer.css', array(), '1.1', 'all');
			wp_enqueue_style('upsite-select2-css', $this->get_upsite_resource_url() . 'customizer-custom-controls/css/select2.min.css', array(), '4.0.13', 'all');
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Dropdown_Posts_Custom_Control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_TinyMCE_Custom_control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
		...
		{
			parent::to_json();
			$this->json['upsitetinymcetoolbar1'] = isset($this->input_attrs['toolbar1']) ? esc_attr($this->input_attrs['toolbar1']) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['upsitetinymcetoolbar2'] = isset($this->input_attrs['toolbar2']) ? esc_attr($this->input_attrs['toolbar2']) : '';
			$this->json['upsitemediabuttons'] = isset($this->input_attrs['mediaButtons']) && ($this->input_attrs['mediaButtons'] === true) ? true : false;
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Google_Font_Select_Custom_Control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct($manager, $id, $args = array(), $options = array())
		{
			...
			$this->fontList = $this->upsite_getGoogleFonts('all');
			// Decode the default json font value
			$this->fontValues = json_decode($this->value());
			// Find the index of our default font within our list of Google fonts
			$this->fontListIndex = $this->upsite_getFontIndex($this->fontList, $this->fontValues->font);
		}
		/**
		 * Enqueue our scripts and styles
		 */
		...
		{
			parent::to_json();
			$this->json['upsitefontslist'] = $this->fontList;
		}
		/**
		 * Render the control in the customizer
		 */
		public function render_content()
		{
			...
			?>
				<div class="google_fonts_select_control">
					...
					<div class="customize-control-description"><?php esc_html_e('Select weight & style for regular text', 'upsite') ?></div>
					...
					<div class="customize-control-description"><?php esc_html_e('Select weight for', 'upsite') ?> <italic><?php esc_html_e('italic text', 'upsite') ?></italic>
					</div>
					<div class="weight-style">
					...
					<div class="customize-control-description"><?php esc_html_e('Select weight for', 'upsite') ?> <strong><?php esc_html_e('bold text', 'upsite') ?></strong></div>
					<div class="weight-style">
		 ...
		 */
		public function upsite_getFontIndex($haystack, $needle)
		{
		 ...
		 */
		public function upsite_getGoogleFonts($count = 30)
		{
			// Google Fonts json generated from https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=YOUR-API-KEY
			$fontFile = $this->get_upsite_resource_url() . 'inc/google-fonts-alphabetical.json';
			if ($this->fontOrderBy === 'popular') {
				$fontFile = $this->get_upsite_resource_url() . 'inc/google-fonts-popularity.json';
			}
	 ...
	 */
	class upsite_Customize_Alpha_Color_Control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue()
		{
			wp_enqueue_script('upsite-custom-controls-js', $this->get_upsite_resource_url() . 'customizer-custom-controls/js/customizer.js', array('jquery', 'wp-color-picker'), '1.0', true);
			wp_enqueue_style('upsite-custom-controls-css', $this->get_upsite_resource_url() . 'customizer-custom-controls/css/customizer.css', array('wp-color-picker'), '1.0', 'all');
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class upsite_Alpha_Color_Control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
		...
		{
			wp_enqueue_style('upsite-custom-controls-css', $this->get_upsite_resource_url() . 'customizer-custom-controls/css/customizer.css', array(), '1.0', 'all');
			wp_enqueue_script('wp-color-picker-alpha', $this->get_upsite_resource_url() . 'customizer-custom-controls/js/wp-color-picker-alpha-min.js', array('wp-color-picker'), '1.0', true);
	 ...
	 * @link https://github.com/brunoOLobato
	 */
	class upsite_Pill_Checkbox_Custom_Control extends upsite_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue()
		{
			wp_enqueue_script('upsite-custom-controls-js', $this->get_upsite_resource_url() . 'customizer-custom-controls/js/customizer.js', array('jquery', 'jquery-ui-core'), '1.1', true);
			wp_enqueue_style('upsite-custom-controls-css', $this->get_upsite_resource_url() . 'customizer-custom-controls/css/customizer.css', array(), '1.0', 'all');
		}
		/**
		 * Render the control in the customizer
	 ...
	 *
	 */
	class upsite_Upsell_Section extends upsite_Custom_Section
	{
		/**
		 * The type of control being rendered
		 */
		public $type = 'upsite-upsell';
		/**
		 * The Upsell URL
		 */
		public $url = '';
		...
		?>
			<li id="accordion-section-<?php echo esc_attr($this->id); ?>" class="upsite_upsell_section accordion-section control-section control-section-<?php echo esc_attr($this->id); ?> cannot-expand">
...
<?php
	 ...
	 */
	if (!function_exists('upsite_url_sanitization')) {
		function upsite_url_sanitization($input)
		{
	 ...
	 */
	if (!function_exists('upsite_switch_sanitization')) {
		function upsite_switch_sanitization($input)
		{
			if (true === $input) {
				return 1;
			} else {
	 ...
	 * @return integer	Sanitized value
	 */
	if (!function_exists('upsite_radio_sanitization')) {
		function upsite_radio_sanitization($input, $setting)
		{
	 ...
	 */
	if (!function_exists('upsite_sanitize_integer')) {
		function upsite_sanitize_integer($input)
		{
			return (int) $input;
		}
	}
	 ...
	 * @return string	Sanitized input
	 */
	if (!function_exists('upsite_text_sanitization')) {
		function upsite_text_sanitization($input)
		{
			if (strpos($input, ',') !== false) {
				$input = explode(',', $input);
			}
	 ...
	 */
	if (!function_exists('upsite_array_sanitization')) {
		function upsite_array_sanitization($input)
		{
			if (is_array($input)) {
				foreach ($input as $key => $value) {
					$input[$key] = sanitize_text_field($value);
	 ...
	 * @return string	Sanitized input
	 */
	if (!function_exists('upsite_hex_rgba_sanitization')) {
		function upsite_hex_rgba_sanitization($input, $setting)
		{
			...
			if (false === strpos($input, 'rgb')) {
				...
				if (false === strpos($input, 'rgba')) {
					...
					$input = 'rgb(' . upsite_in_range($red, 0, 255) . ',' . upsite_in_range($green, 0, 255) . ',' . upsite_in_range($blue, 0, 255) . ')';
				} else {
					// Sanitize as RGBa color
					$input = str_replace(' ', '', $input);
					sscanf($input, 'rgba(%d,%d,%d,%f)', $red, $green, $blue, $alpha);
					$input = 'rgba(' . upsite_in_range($red, 0, 255) . ',' . upsite_in_range($green, 0, 255) . ',' . upsite_in_range($blue, 0, 255) . ',' . upsite_in_range($alpha, 0, 1) . ')';
				}
			}
			return $input;
		}
	 ...
	 */
	if (!function_exists('upsite_in_range')) {
		function upsite_in_range($input, $min, $max)
		{
			if ($input < $min) {
				$input = $min;
			}
	 ...
	 * @return string	Sanitized input
	 */
	if (!function_exists('upsite_google_font_sanitization')) {
		function upsite_google_font_sanitization($input)
		{
	 ...
	 * @return string	Sanitized input
	 */
	if (!function_exists('upsite_date_time_sanitization')) {
		function upsite_date_time_sanitization($input, $setting)
		{
	 ...
	 * @return string	Sanitized input
	 */
	if (!function_exists('upsite_range_sanitization')) {
		function upsite_range_sanitization($input, $setting)
		{
			...
			return upsite_in_range($number, $min, $max);
		}
	}
}
