...
<main style="color: <?php echo $tcolor_arr[0] ?>;">
  ...
  <section id="postCont">
    <div class="container grid">
      <div class="img" style="background-image: url(<?php echo get_field('imagem_destacada')['url'] ?>);">
        <?php
        if (get_field('imagem_destacada')['caption'] != '') {
          echo '<legend>' . get_field('imagem_destacada')['caption'] . '</legend>';
        }
        ?>
      </div>
