...
final class Str
{
    ...
    {
        return self::$useMultibyte && \function_exists('mb_strlen') ? \mb_strlen($text) : \strlen($text);
    }
    /**
    ...
    {
        return self::$useMultibyte && \function_exists('mb_strpos') ? \mb_strpos($text, $substring, $offset) : \strpos($text, $substring, $offset);
    }
    /**
    ...
    {
        return self::$useMultibyte && \function_exists('mb_strrpos') ? \mb_strrpos($text, $substring, $offset) : \strrpos($text, $substring, $offset);
    }
    /**
    ...
    {
        return self::$useMultibyte && \function_exists('mb_strtolower') ? \mb_strtolower($text) : \strtolower($text);
    }
    /**
    ...
    {
        return self::$useMultibyte && \function_exists('mb_strtoupper') ? \mb_strtoupper($text) : \strtoupper($text);
    }
    /**
    ...
    public static function regexMatch($pattern, $text, &$matches = null)
    {
        if (self::$useMultibyte && \function_exists('mb_ereg')) {
            ...
            return self::position($modifiers, 'i') === \false ? \mb_ereg($pattern, $text, $matches) : \mb_eregi($pattern, $text, $matches);
        }
